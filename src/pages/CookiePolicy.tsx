      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-foreground/90">
          ...
          <section className="space-y-4">
            ...
            <h3 className="text-xl font-semibold text-foreground mt-4">Essential Cookies</h3>
            <p>
              These cookies are necessary for the website to function properly. They enable basic functions like page navigation and access to secure areas of the website.
            </p>

            <h3 className="text-xl font-semibold text-foreground mt-4">Performance Cookies</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold text-foreground mt-4">Functionality Cookies</h3>
            <p>
